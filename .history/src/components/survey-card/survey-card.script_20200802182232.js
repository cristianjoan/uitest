...
export default {
    ...
    methods: {
        ...
        calcPorcent(thumb) {
            if (thumb === 'up' && this.voteData.thumbsUp && this.voteData.votesNumber) {
                return (this.voteData.thumbsUp / this.voteData.votesNumber) * 100 + '%';
            } else if (thumb === 'down' && this.voteData.thumbsUp && this.voteData.votesNumber) {
                return (this.voteData.thumbsDown / this.voteData.votesNumber) * 100 + '%';
            } else {
                return '50%'
            }
        }
